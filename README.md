...
>
> This repository was renamed from `kirby-forms` to `kirby-form-builder` in version `0.9.0`. Please update your dependencies and config options accordingly, see [release note](https://github.com/arnoson/kirby-form-builder/releases/tag/v0.9.0).
